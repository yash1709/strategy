...
```
GitHub Actions, weekdays 17:37 IST, then 00:22 and 08:37 IST the following night/morning (Tue-Sat)
...
the price history once. After that it runs by itself Mon–Fri at 17:37 IST, and Tue–Sat at 00:22 and 08:37 IST (covering the previous session). GitHub may start
